...
# Submit top 20 predictions for each test instance. Added by Sophie.
...
class ModelExporter(object):
    ...
    def build_prediction_graph(self, serialized_examples):
        """
        Make predictions using self.model. Added by Sophie.
        :param serialized_examples: a placeholder to hold instances.
        :return: video_id, top prediction labels, and top prediction probabilities
        """
        ...
        with tf.name_scope("model"):
            ...
            # Finds values and indices of the `k` largest entries for the last dimension. From top_k doc.
            top_predictions, top_indices = tf.nn.top_k(predictions, k=_TOP_PREDICTIONS_IN_OUTPUT)
